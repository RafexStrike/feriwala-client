...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-oklch(1 0 0) p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out dark:bg-oklch(0.145 0 0)",
  {
    variants: {
      side: {
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("text-lg font-semibold text-oklch(0.145 0 0) dark:text-oklch(0.985 0 0)", className)}
    {...props}
  />
))
